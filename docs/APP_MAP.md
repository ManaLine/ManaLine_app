...
| Literal navigation call sites | 378 |
...
|---|---|---|---|---|---|---|
| `/lr-001` | `SystemStartupScreen` | `features/login_registration/screens/lr_001_system_startup.dart` | — | both | 6 via path | yes |
| `/lr-002` | `WorkspaceChoiceScreen` | `features/login_registration/screens/lr_002_workspace_choice.dart` | — | both | 3 via path | yes |
...
| `/lr-006` | `RegistrationResultScreen` | `features/login_registration/screens/lr_006_registration_result.dart` | — | both | 3 via path | yes |
...
| `/lr-012` | `BusinessSelectorScreen` | `features/login_registration/screens/lr_012_business_selector.dart` | `?pick` | both | 16 via path | yes |
| `/lr-013` | `RoleSelectorScreen` | `features/login_registration/screens/lr_013_role_selector.dart` | — | both | 7 via path | yes |
...
| `/ow-001` | `OwnerHomeDashboardScreen` | `features/owner_workspace/screens/ow_001_owner_home_dashboard.dart` | — | handset | 29 via path | yes |
...
| Route | Screen | File | Takes | On | Reached from | Test |
|---|---|---|---|---|---|---|
| `/ag-001` | `AgentHomeDashboardScreen` | `features/agent_workspace/screens/ag_001_agent_home_dashboard.dart` | `?anchor` | handset | 15 via path | yes |
...
| Route | Screen | File | Takes | On | Reached from | Test |
|---|---|---|---|---|---|---|
| `/cw-001` | `CustomerHomeDashboardScreen` | `features/customer_workspace/screens/cw_001_customer_home_dashboard.dart` | — | handset | 15 via path | yes |
...
| Route | Screen | File | Takes | On | Reached from | Test |
|---|---|---|---|---|---|---|
| `/iw-001` | `InvestorHomeDashboardScreen` | `features/investor_workspace/screens/iw_001_investor_home_dashboard.dart` | — | handset | 11 via path | yes |
...
| `/web-home` | `ManaWebHomeScreen` | `features/web/screens/web_home_screen.dart` | — | web | 8 via path | yes |
...
- `app/web_router.dart:207` (`listed`)
...
- `app/web_router.dart:211` (`listed`)
...
- `app/web_router.dart:166` (`listed`)
...
- `features/web/screens/web_home_screen.dart:85` (`listed`)
- `shared/settings_screen.dart:84` (`listed`)
...
- `app/web_router.dart:73` (`listed`)
- `app/web_router.dart:208` (`listed`)
...
- `app/web_router.dart:212` (`listed`)
...
- `app/web_router.dart:175` (`listed`)
...
- `features/web/screens/web_home_screen.dart:90` (`listed`)
...
- `app/web_router.dart:70` (`listed`)
- `app/web_router.dart:182` (`listed`)
...
- `features/web/screens/web_home_screen.dart:91` (`listed`)
- `shared/settings_screen.dart:85` (`listed`)
...
- `app/web_router.dart:196` (`listed`)
...
- `features/web/screens/web_home_screen.dart:97` (`listed`)
...
- `app/web_router.dart:71` (`listed`)
- `app/web_router.dart:203` (`listed`)
...
- `features/web/screens/web_home_screen.dart:98` (`listed`)
- `shared/settings_screen.dart:86` (`listed`)
...
- `app/web_router.dart:66` (`listed`)
- `app/web_router.dart:137` (`listed`)
...
- `features/owner_workspace/screens/ow_012_business_management.dart:552` (`listed`)

**`/ow-013`** — 6 call sites

- `app/web_router.dart:68` (`listed`)
- `app/web_router.dart:144` (`listed`)
- `design/tokens/breakpoints.dart:72` (`listed`)
...
- `features/owner_workspace/screens/ow_012_business_management.dart:567` (`push`)
- `features/owner_workspace/screens/ow_012_business_management.dart:1276` (`push`)
...
- `features/web/screens/web_home_screen.dart:75` (`listed`)
...
- `app/web_router.dart:141` (`listed`)
- `app/web_router.dart:280` (`go`)
