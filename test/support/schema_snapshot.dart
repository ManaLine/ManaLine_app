...
const manaDbEnums = <String, List<String>>{
  ...
  'location_source_enum': ['Directory', 'Owner Entered', 'Seed'],
...
const manaAppFunctions = <String>{
  ...
  'attach_person_to_business', 'attach_person_to_business_roles',
  ...
  'confirm_cash_transfer', 'correct_location_place',
  'covering_agent_membership_id',
  ...
  'ledger_history', 'ledger_month_summary', 'lgd_districts', 'lgd_states',
  'list_agent_areas',
  ...
  'pin_administrative_options', 'place_options_for_village',
  ...
  'submit_draft', 'suggest_similar_villages', 'suggest_villages',
  'support_fetch_latest_id_history',
...
const manaEnumColumns = <String, String>{
  ...
  'locations.source': 'location_source_enum',
